...
class MightySlamTrait extends BossTrait
{
    ...
    function Perform()
    {
        ...
        local slamIgniteTrigger = Entities.FindByName(null, "slam_ignite");
        if (slamIgniteTrigger != null)
        {
            slamIgniteTrigger.SetAbsOrigin(boss.GetOrigin());
            EntFireByHandle(slamIgniteTrigger, "Enable", "", 0, null, null);
            EntFireByHandle(slamIgniteTrigger, "Disable", "", 0.5, null, null);
        }
